...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfAccType = new javax.swing.JComboBox<>();
        ...
        tfBirth = new com.toedter.calendar.JDateChooser();
        ...
        bgCusList.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bgCusListMouseClicked(evt);
            }
        });
        ...
        tfCustomerID.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        tfAddress.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        tfAddress.setRows(5);
        ...
        tfAccType.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tfAccType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiết kiệm", "Thanh toán" }));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(tfAccType, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
                    .addComponent(tfContact)
                    .addComponent(tfName)
                    .addComponent(tfCustomerID)
                    .addComponent(tfBirth, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(39, 39, 39))
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(77, 77, 77)
    ...
    private void bgCusListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bgCusListMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_bgCusListMouseClicked
    ...
    private void init(EmployeeModel model) {
        ...
        lblUser.setText(model.getHoTen());
        resizeImage(model);
        renderNewId();
    }
    ...
    private void renderNewId() {
        ...
        tfCustomerID.setText("KH_" + new_id);
    }

    private void saveNewCustomer() {
        CustomerModel newModel = new CustomerModel();
        newModel.setId(tfCustomerID.getText());
        newModel.setHoTen(tfName.getText());
        newModel.setDiaChi(tfAddress.getText());
        newModel.setSoDT(tfContact.getText());
        if (rbMale.isSelected()) {
            newModel.setGioiTinh(false);
        } else {
            newModel.setGioiTinh(true);
        }
        newModel.setNgaySinh(tfBirth.getDate());
        newModel.setEmail(tfEmail.getText());
    ...
    private javax.swing.JComboBox<String> tfAccType;
    private javax.swing.JTextArea tfAddress;
    private com.toedter.calendar.JDateChooser tfBirth;
